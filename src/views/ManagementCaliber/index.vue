<template>
	<div class="temporary1">
					...
					<div class="subBtn">
						<el-form-item class=" margin-12">
							<el-button type="primary" @click="onSubmit(ruleFormRef)" icon="Search"
								...
								data-track-id="ManagementCaliber-submit-btn"
								data-track-name="管理口径资产分类与收益率统计表-查询">查询</el-button>
							...
							<el-button @click="handleDownload(ruleFormRef)" icon="Download" :loading="DownloadLoading"
								class="button-custom" data-track-id="ManagementCaliber-Download-btn"
								data-track-name="管理口径资产分类与收益率统计表-导出" :disabled="downloadBool">导出</el-button>
						</el-form-item>
					</div>
				</el-form>
			</div>
		...
		<el-card>
			<TitleMargin title="管理口径资产分类与收益率统计表">
...
<script lang="ts" setup>
	...
	import { handleExportFile } from "@/api/ManagementCaliber.js";
