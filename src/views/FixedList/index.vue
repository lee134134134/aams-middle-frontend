					...
					<div class="subBtn">
						<el-form-item class=" margin-12">
							<el-button type="primary" @click="onSubmit(ruleFormRef)" icon="Search" :loading="SearchLoading"
								class="button-custom color-button" data-track-id="FixedList-submit-btn"
								data-track-name="固定类组合一览表-查询">查询</el-button>
							...
							<el-button @click="detailData(ruleFormRef)" icon="Download" :loading="DownloadLoading"
								class="button-custom" data-track-id="FixedList-Download-btn" data-track-name="固定类组合一览表-导出"
...
import { handleExportFile } from "@/api/FixedList.js";
