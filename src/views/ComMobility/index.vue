<template>
	<div class="temporary1">
					...
					<div class="subBtn">
						<el-form-item>
							<el-button type="primary" @click="onSubmit(ruleFormRef)" icon="Search" :loading="SearchLoading"
								class="button-custom color-button" data-track-id="ComMobility-submit-btn"
								data-track-name="公司流动性统计-查询">查询</el-button>
							...
							<el-button @click="handleDownload(ruleFormRef)" icon="Download" :loading="DownloadLoading"
								class="button-custom" data-track-id="ComMobility-Download-btn" data-track-name="公司流动性统计-导出"
		...
		<el-card>
			<TitleMargin title="公司流动性资产分布情况统计表">
...
import { handleExportFile } from "@/api/ComMobility.js";
