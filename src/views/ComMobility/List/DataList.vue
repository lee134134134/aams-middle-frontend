<template>
	<el-table v-loading="props.isLoading" ref="tableRef" style="width: 100%" show-overflow-tooltip
		empty-text="请输入查询条件并点击查询" :max-height="tableHeight" :data="tableData" :row-key="getRowKey" :header-cell-style="{
            background: '#E4EFFF',
            color: '#333333',
            height: '38px',
        }" border :tree-props="{ children: 'children' }" :expand-row-kes="expandedKeys" :row-style="handleRowStyle"
		:row-class-name="setRowClassName">
		<el-table-column prop="investManager" label="部门/投资经理" min-width="180" show-overflow-tooltip align="left"
			fixed="left">
...
<script lang="ts" setup>
	...
	import { getList, } from "@/api/ComMobility.js";
