<template>
  ...
  <el-pagination v-model:current-page="currnetPage" v-model:page-size="pageSize" :page-sizes="[10, 20, 30, 50, 100]"
    ...
    data-track-id="FloatingPL-pagination7-btn" data-track-name="浮盈亏情况跟踪表-债券基金-分页" @size-change="handleSizeChange"
...
watch(() => props.bondFundList, (newVal, oldVal) => {
  currnetPage.value = 1
  pageSize.value = 10
  pageAll.total = props.bondFundList.length;
