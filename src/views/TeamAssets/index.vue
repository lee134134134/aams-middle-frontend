					...
					<div class="subBtn">
						<el-form-item class=" margin-12">
							<el-button type="primary" @click="onSubmit(ruleFormRef)" icon="Search" :loading="SearchLoading"
								class="button-custom color-button" data-track-id="TeamAssets-submit-btn"
								data-track-name="团队资产时序查询-查询">查询</el-button>
							...
							<el-button @click="handleDownload(ruleFormRef)" icon="Download" :loading="DownloadLoading"
								class="button-custom" data-track-id="TeamAssets-Download-btn" data-track-name="团队资产时序查询-导出"
...
import { handleExportFile } from "@/api/TeamAssets.js";
import { getList, getAssetType } from "@/api/TeamAssets.js";
...
import { getChildrenCode, getValueArr1, filterTreeArr, compareObject, filterFormArr } from "@/utils/index.js";
...
let getContentList = (obj: any) => {
	...
	getList({ ...obj, sobCodeList: formInline.sobCodeList.sort(), selfAcountTree: getValueArr1(selectDataArr.value, obj.selfAcountTree) })
		.then((res) => {
